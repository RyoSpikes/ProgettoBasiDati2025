...
\begin{document}
	...
	\begin{itemize}
		\item \texttt{Hackathon(\underline{Titolo\_identificativo}, Sede, Classifica, DataInizio\_registrazione, DataFine\_registrazione, Descrizione\_problema, DataInizio\_evento, DataFine\_evento, NumIscritti\_corrente, MaxNum\_iscritti)}
		...
		\tab \texttt{Username\_utente $\Rightarrow$ Utente.Username}\\
		\tab \texttt{Titolo\_hackathon $\Rightarrow$ Hackathon.Titolo\_identificativo}
		...
		\tab \texttt{Nome\_team $\Rightarrow$ Team.Nome\_team}\\
		\tab \texttt{Titolo\_hackathon $\Rightarrow$ Hackathon.Titolo\_identificativo}
		...
		\tab \texttt{ID\_giudice $\Rightarrow$ Giudice.ID\_giudice}\\
		\tab \texttt{Username\_giudice $\Rightarrow$ Utente.Username}\\
		\tab \texttt{Titolo\_hackathon $\Rightarrow$ Hackathon.Titolo\_identificativo}
		\tab \texttt{Nome\_team $\Rightarrow$ Team.Nome\_team}
			...
			\tab \texttt{Titolo\_hackathon $\Rightarrow$ Hackathon.Titolo\_identificativo}
			\tab \texttt{Nome\_team $\Rightarrow$ Team.Nome\_team}\\
			\tab \texttt{ID\_documento $\Rightarrow$ Documento.ID\_documento}\\
	\end{itemize}
